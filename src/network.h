...
void evloop_add_callback(struct evloop *, struct clousure *);
...
int evloop_del_callback(struct evloop *, struct clousure *);

int evloop_rearm_callback_read(struct evloop *, struct clousure *);
